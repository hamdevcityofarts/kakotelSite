...
export const footerData2: FooterProps = {
  ...
  columns: [
    {
      title: 'Address',
      texts: ["Siege Social:   Douala Bonamoussadi Immeuble Kakotel face lycee d'Akwa-Nord"],
    },
    {
      title: 'Phone',
      texts: ['Office:',' +237 233 52 00 02','+237 233 52 00 03','+237 233 52 00 04','+237 233 52 00 05'],
    },
    {
      title: 'Email',
      texts: ['Office:','info@kakotel.com', 'sales@kakotel.com'],
    },
  ],
  socials: [
    { label: 'Twitter', icon: IconBrandTwitter, href: '#' },
